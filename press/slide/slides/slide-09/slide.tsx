...
export const meta = {
  layout: "blank",
  description: "New slide placeholder for slide-09. Replace this with the slide purpose before sharing.",
  keypoints: [
    "Add slide content",
    "Update metadata",
    "Run validate"
...
export default function Slide09Slide() {
  return (
    <BlankSlide id="slide-09">
      <BlankSlide.Kicker>New slide</BlankSlide.Kicker>
      <BlankSlide.Title>slide-09</BlankSlide.Title>
