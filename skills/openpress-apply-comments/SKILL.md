...
description: Use when a open-press workspace has pending @qdoc-comment markers from the inspector and the user asks to apply, resolve, review, clear, or manage those comments.
---
