...
.reader-page--report .page-body > h2:first-child::before {
  content: attr(data-chapter);   /* 顯示「02」 */
}

.reader-page--report h3[data-section]::before {
...
/* Chapter h2: 一、 */
.reader-page--report .page-body > h2:first-child {
...
/* Section h3: (一) */
.reader-page--report h3[data-section] {
