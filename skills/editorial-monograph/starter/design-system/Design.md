...
<div class="cover-main">
  ...
  <p class="cover-summary">Design document 拆成多個 source files，讓 Agent 可以按任務讀取對應章節：`style-brief.md` 定義風格定位、`tokens.md` 定義字體 / 色彩 / spacing / page geometry / inline emphasis / 章節編號、`components.md` 定義文件元件規則、`design-checklist.md` 定義驗收檢查。這些檔案共同構成同一份 design document，而不是多套規格。</p>
</div>
