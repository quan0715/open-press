...
This is a **style-pack skill**：除了規則文，還在 `starter/` 內附帶完整可用的 theme + design doc + 起手 content，agent 可在新工作區直接拷貝套用。
...
2. **拷貝 starter 檔案**：
   ...
   skills/editorial-monograph/starter/design.md      → document/design.md
...
editorial-monograph 不單獨維護一份 reference/ 文件——所有規格都寫在 `starter/design.md` 內，跟著 starter 一起拷貝到 workspace 後變成該專案的 design document：
...
>   拷貝 `starter/design.md` → `document/design.md`、
