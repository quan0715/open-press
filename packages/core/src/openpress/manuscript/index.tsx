...
const MDX_PROSE_CLASS = [
  ...
  "[&_code]:rounded-[3px] [&_code]:bg-[rgb(31_35_40_/_0.06)] [&_code]:px-[1.1mm] [&_code]:py-[0.35mm] [&_code]:[font-family:var(--openpress-font-mono)] [&_code]:text-[0.92em] [&_code]:text-[var(--openpress-color-ink)]",
  "[&_pre]:my-[var(--openpress-space-3)] [&_pre]:max-w-full [&_pre]:break-inside-avoid [&_pre]:overflow-hidden [&_pre]:rounded-[5px] [&_pre]:border [&_pre]:border-[var(--openpress-color-line)] [&_pre]:bg-[rgb(31_35_40_/_0.045)] [&_pre]:p-[3.2mm]",
  "[&_pre_code]:block [&_pre_code]:overflow-hidden [&_pre_code]:rounded-none [&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_pre_code]:text-[clamp(3.5pt,1.45cqw,8.5pt)] [&_pre_code]:leading-[1.55] [&_pre_code]:[white-space:pre-wrap] [&_pre_code]:[overflow-wrap:anywhere]",
