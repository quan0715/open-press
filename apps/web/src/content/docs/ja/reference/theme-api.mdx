...
- `press/<slug>/theme/` は引き続き active CSS source です。Font loading、prose rules、slide layout classes、project-specific selectors をここに置きます。
...
<ApiEntry
  ...
  summary="Theme color swatches を描画します。theme-colors slide に適しています。"
/>
