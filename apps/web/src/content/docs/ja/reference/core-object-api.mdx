...
新しい slide source は `Slide`、`Frame`、`Text`、media primitives、style class を直接組み合わせます。`TitleSlide`、`TwoColumnSlide`、`SlideProtocol` のような古い compound wrapper は、新規 workspace の既定ルートではありません。
