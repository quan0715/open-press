...
The older path form remains supported:

```tsx
<Press theme="./theme" />
```

Use the path form only when you want to point a Press at a non-default theme directory. New work should prefer a typed theme object plus the folder-local `press/<slug>/theme/` CSS files.
