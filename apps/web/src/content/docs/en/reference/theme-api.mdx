...
- `press/<slug>/theme/` remains the active CSS source for font loading, prose rules, slide layout classes, and project-specific selectors.
...
<ApiEntry
  ...
  summary="Renders theme color swatches, useful for a theme-colors slide."
/>
