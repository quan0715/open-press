...
* **Build-Time Locators:** The engine maintains build-local locators in the background, allowing the visual interface and source code to map to each other without requiring authors to hand-write locator props.
