...
<div class="callout">
  <strong>Prerequisites.</strong> Please ensure your environment has Node.js 20+ installed along with <code>npm</code> and <code>npx</code>. For framework development or Cloudflare Pages deployment, Node.js 24 is recommended. PDF/image export requires Chromium; Word DOCX export does not require a browser; deployment requires <code>wrangler</code>.
</div>
...
<ul>
  <li><a href="/docs/concepts/slides">Slides Architecture</a> — Press markers, folder-per-slide source, template registry, and core object identity.</li>
  ...
  <li><a href="/docs/concepts/themes">Themes</a> — The <code>press/&lt;slug&gt;/theme/</code> contract.</li>
