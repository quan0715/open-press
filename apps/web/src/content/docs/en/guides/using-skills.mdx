...
- **Collaboration:** `openpress-collaborate` (analysis, exact change previews, comments, and reviewed edits), with `openpress-apply-comments` handling the lower-level inline comment markers.
