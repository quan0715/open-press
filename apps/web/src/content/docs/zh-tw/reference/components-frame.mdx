...
>
  ...
  >
    <PropsTable
      ...
      rows={[
        ...
        },
        {
          ...
          required: true,
          description:
            "頁面內容。通常是一個或多個 <code>&lt;MdxArea&gt;</code> 插槽，包在 component 自己擁有的 layout 裡，並由 Tailwind class 或 protocol utilities 定義視覺表面。",
        },
        {
          name: "role",
          type: "string",
    ...
    <h3>範例：A4 內容頁面 (manuscript role)</h3>
