...
export const showcases: Record<"zh-tw" | "en" | "ja", ShowcaseItem[]> = {
  "zh-tw": [
    ...
    },
    {
      slug: "amao-menu",
      title: "Amao 自家焙煎喫茶菜單",
      href: "http://127.0.0.1:8787/workspace",
      description: "結合日式和紙質感、極簡 Zine 海報與單欄排版的四頁精品咖啡廳菜單。",
      audience: "需要高品質可印製品味菜單、型錄與小誌的品牌與店家。",
      documentType: "品牌菜單",
      sourceMaterial: "自家配方咖啡豆、產地單品手沖筆記、台灣茶品與手作甜點清單。",
      prompt: "為 Amao 咖啡廳製作一份極具日式極簡小誌（Zine）質感的四頁 A4 菜單。包含 Full Bleed 和紙封面與封底、全寬單欄排版、清晰醒目的價格與品飲筆記。",
      cover: asset("amao-menu", "cover.png"),
      pages: [asset("amao-menu", "cover.png"), asset("amao-menu", "back-cover.png")],
      pageCount: 4,
      proof: "real",
    },
    {
  ...
  en: [
    ...
    {
      slug: "amao-menu", title: "Amao Coffee Roasters Menu", href: "http://127.0.0.1:8787/workspace",
      description: "A 4-page Japanese minimal editorial zine menu with textured paper art and clean typography.", audience: "Cafés and lifestyle brands needing printable, high-end editorial menus.", documentType: "Brand menu", sourceMaterial: "House blend espresso, single origin hand drip, artisanal teas, and bakery items.",
      prompt: "Create a 4-page Japanese minimal zine menu for Amao Coffee Roasters. Include full-bleed paper-textured cover and back cover, single-column full-width menu items, and prominent pricing.",
      cover: asset("amao-menu", "cover.png"), pages: [asset("amao-menu", "cover.png"), asset("amao-menu", "back-cover.png")], pageCount: 4, proof: "real",
    },
    {
  ...
  ja: [
    ...
    {
      slug: "amao-menu", title: "Amao 自家焙煎喫茶メニュー", href: "http://127.0.0.1:8787/workspace",
      description: "和紙の質感とミニマルなZineデザインを融合した4ページの店舗用プリントメニュー。", audience: "印刷品質の高いメニューやZineを作成したいカフェやブランド。", documentType: "カフェメニュー", sourceMaterial: "自家焙煎豆リスト、シングルオリジン手淹れノート、台湾茶と自家製スイーツ。",
      prompt: "Amao Coffeeのために和紙質感のZineスタイルメニューを作成してください。全面印刷の表紙・裏紙、1カラムのすっきりとした配置、見やすい価格表記を含めます。",
      cover: asset("amao-menu", "cover.png"), pages: [asset("amao-menu", "cover.png"), asset("amao-menu", "back-cover.png")], pageCount: 4, proof: "real",
    },
    {
      ...
      prompt: "再計算可能な架空データを使い、Northstar Goodsの2025年次報告書を作成してください。事業説明と損益、財務狀況、キャッシュフローを一致させ、デモデータかつ投資助言ではないと明示し、存在しない実績や予測を加えないでください。",
      cover: asset("financial-report", "cover.png"), pages: [asset("financial-report", "cover.png"), asset("financial-report", "page-03.png"), asset("financial-report", "page-04.png")], pageCount: 8, proof: "demo",
    },
    {
