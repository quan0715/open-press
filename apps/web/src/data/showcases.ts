...
export const showcases: Record<"zh-tw" | "en" | "ja", ShowcaseItem[]> = {
  "zh-tw": [
    ...
    },
    {
      slug: "resume",
      title: "虛構產品工程師履歷",
      description: "兩頁完成版履歷，從個人摘要、經歷一路到精選作品。",
      audience: "需要快速製作專業履歷的工程師與求職者。",
      documentType: "履歷",
      sourceMaterial: "虛構職涯經歷、專案成果、技能與學歷。",
      prompt: "把這份虛構產品工程師的職涯資料整理成兩頁履歷。優先呈現可驗證的工作成果、角色範圍與產品判斷，保持資訊密度，但不要犧牲掃讀性。所有姓名、公司與成果都要標示為示範資料。",
      cover: asset("resume", "cover.png"),
      pages: [asset("resume", "cover.png"), asset("resume", "page-02.png")],
      pageCount: 2,
      proof: "demo",
    },
    {
  ...
  en: [
    ...
    {
      slug: "resume", title: "Fictional Product Engineer Resume", description: "A complete two-page resume, from profile and experience to selected work.", audience: "Engineers and job seekers who need a professional resume quickly.", documentType: "Resume", sourceMaterial: "Fictional work history, project outcomes, skills, and education.",
      prompt: "Turn this fictional product engineer career history into a two-page resume. Lead with concrete outcomes, role scope, and product judgment while keeping it easy to scan. Mark every name, company, and result as sample data.",
      cover: asset("resume", "cover.png"), pages: [asset("resume", "cover.png"), asset("resume", "page-02.png")], pageCount: 2, proof: "demo",
    },
    {
      slug: "school-report", title: "Fictional School Report", description: "A five-page report covering the question, method, observations, and reflection.", audience: "Students and teachers turning classwork into a formal document.", documentType: "School report", sourceMaterial: "Fictional survey data, observation notes, a research question, and reference formatting.",
    ...
    {
      slug: "financial-report", title: "Fictional Annual Financial Report", description: "An eight-page annual report with operations, position, and cash-flow statements.", audience: "Founders, analysts, and designers who need a financial narrative and statement layout.", documentType: "Annual financial report", sourceMaterial: "Recalculable fictional financial data, an operating summary, and accounting notes.",
  ...
  ja: [
    ...
    {
      slug: "resume", title: "架空のプロダクトエンジニア履歴書", description: "プロフィール、職歴、実績をまとめた完成版2ページ履歴書。", audience: "短時間で専門的な履歴書を作りたいエンジニアと求職者。", documentType: "履歴書", sourceMaterial: "架空の職歴、成果、スキル、学歴。",
      prompt: "架空のプロダクトエンジニアの経歴を2ページの履歴書にしてください。具体的な成果、役割の範囲、プロダクト判断を優先し、読みやすさを保ってください。氏名、会社、成果はすべてサンプルだと明示してください。",
      cover: asset("resume", "cover.png"), pages: [asset("resume", "cover.png"), asset("resume", "page-02.png")], pageCount: 2, proof: "demo",
    },
    {
      slug: "school-report", title: "架空の学校レポート", description: "問い、方法、観察、考察を収めた5ページの完成レポート。", audience: "授業課題を正式な文書にしたい学生と教師。", documentType: "学校レポート", sourceMaterial: "架空のアンケート、観察記録、研究課題、参考文献形式。",
      prompt: "犬との暮らし、自信、仲間意識をテーマに学校レポートを完成させてください。研究課題、方法、サンプルデータ、図表、考察、限界、振り返りを含め、人物、数値、引用がすべて架空であることを明示してください。",
      cover: asset("school-report", "cover.png"), pages: [asset("school-report", "cover.png"), asset("school-report", "page-03.png")], pageCount: 5, proof: "demo",
    },
    {
      slug: "financial-report", title: "架空の年次財務報告書", description: "損益、財政状態、キャッシュフローを含む8ページの年次報告書。", audience: "財務ストーリーと計算書レイアウトが必要な創業者、分析者、デザイナー。", documentType: "年次財務報告書", sourceMaterial: "再計算できる架空の財務データ、事業概要、会計注記。",
    ...
    {
      slug: "thesis", title: "クラシック学位論文テンプレート", description: "架空の都市熱研究を収めた10ページのクラシック論文例。", audience: "伝統的な論文構成と組版の起点が必要な大学院生と研究者。", documentType: "学位論文", sourceMaterial: "架空の問い、方法、96件のサンプル観察、参考文献形式。",
